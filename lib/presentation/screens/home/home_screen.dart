...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<List<SearchResult>> _searchListsAndTasks(String query, BuildContext context) async {
                      ...
                      return BlocBuilder<TaskBloc, TaskState>(
                        builder: (context, taskState) {
                                    ...
                                    child: TextField(
                                      ...
                                      onChanged: (query) async {
                                        if (query.isNotEmpty) {
                                          ...
                                          try {
                                            final results = await _searchListsAndTasks(query, context);
                                            if (mounted) {
                                              setState(() {
                                        ...
                                        return Card(
                                          child: ListTile(
                                            ...
                                            subtitle: Column(
                                              ...
                                              children: [
                                                Text(result.path),
                                                Text(result.isTask ? 'Задача' : 'Список'),
                                              ],
                                            ),
                                            onTap: () {
                                              print('HomeScreen: Selected search result: ${result.id}, isTask: ${result.isTask}');
                                              context
                                                  .read<ListBloc>()
                                              ...
                                              final selectedList = (listState as ListLoaded)
                                                  .lists
                                                  .firstWhere(
                          ...
                          if (listState is ListLoaded && listState.lists.isNotEmpty) {
                            ...
                            final isMainList = selectedList.name.toLowerCase() == 'основной';
                            ...
                            return RefreshIndicator(
                              onRefresh: () async {
                                ...
                                if (listState.selectedListId != null) {
                                  ...
                                  if (isMainList) {
                                    listBloc.add(LoadTasksForList(listState.selectedListId!));
                                  } else {
                                    taskBloc.add(LoadTasks(listState.selectedListId!));
                                  }
                                }
                              },
                                      ...
                                      child: Card(
                                        ...
                                        child: ListTile(
                                            ...
                                            children: [
                                              Checkbox(
                                                ...
                                                onChanged: (value) {
                                                  ...
                                                  context
                                                      .read<TaskBloc>()
                                                      .add(UpdateTask(task.copyWith(isCompleted: value ?? false)));
                                                },
                                              ),
                                              const CircleAvatar(
                                          ...
                                          subtitle: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              if (isMainList && taskList != null) Text('Список: ${taskList.name}'),
                            ...
                            return Center(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      onPressed: () {
                                        if (listState is ListLoaded && listState.selectedListId != null) {
                                          final selectedList = listState.lists
                                              .firstWhere(
                                                (l) => l.id == listState.selectedListId!,
                                            orElse: () => listState.lists.first,
                                          );
